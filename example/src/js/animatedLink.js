...
class LinkFx {
  constructor(el) {
    ...
    this.DOM.el.dataset.text != undefined && (this.options.animation.text = this.DOM.el.dataset.text !== 'false');
    this.DOM.el.dataset.line != undefined && (this.options.animation.line = this.DOM.el.dataset.line !== 'false');
...
class LinkFx1 extends LinkFx {
  constructor(el) {
    ...
    console.log(this.DOM.feTurbulence);
    this.primitiveValues = { turbulence: 0 };

    this.createTimeline();
    this.tl.eventCallback('onUpdate', () => {
      // console.log('Updated');
      // console.log(this.primitiveValues.turbulence);
